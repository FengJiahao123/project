    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-paper">
      <div className="w-full max-w-[380px]">
        ...
        <div className="text-center mb-10">
          <div className="w-16 h-16 rounded-2xl bg-soft-amber/60 flex items-center justify-center mx-auto mb-5">
            <Icon name="sparkles" size={28} className="text-warm-gray" />
          </div>
          <h1 className="font-serif text-[26px] font-bold text-ink tracking-tight mb-1.5">小说转剧本工坊</h1>
          <p className="text-[13px] text-warm-gray-light">将文字编成光影，让故事登上舞台</p>
        </div>
        ...
        <div className="card-warm p-7">
          <div className="space-y-4">
            <div>
              ...
              <div className="relative">
                <div className="absolute left-0 top-1/2 -translate-y-1/2 text-warm-gray-light/40">
                  <Icon name="user" size={15} />
                </div>
                <input
                  className="input-underline pl-7 placeholder:text-warm-gray-light/40"
          ...
          <button onClick={handleSubmit} disabled={loading || !username.trim() || !password.trim()}
          ...
          <p className="text-center mt-5 text-[12px] text-warm-gray-light">
            ...
            <button className="text-ink font-medium ml-1 hover:underline"
        ...
        <p className="text-center mt-8 text-[11px] text-warm-gray-light/60 tracking-wide">
          从小说到剧本，AI 铺就改编之路
        </p>
      </div>
    </div>
